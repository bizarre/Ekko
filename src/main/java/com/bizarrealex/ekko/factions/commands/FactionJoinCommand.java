...
import com.bizarrealex.ekko.factions.events.player.PlayerJoinFactionEvent;
...
public class FactionJoinCommand extends FactionCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        Ekko.getInstance().getServer().getPluginManager().callEvent(new PlayerJoinFactionEvent(player, playerFaction));
    }
}
