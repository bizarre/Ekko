...
public class FactionRenameCommand extends FactionCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        Ekko.getInstance().getServer().broadcastMessage(langConfig.getString("ANNOUNCEMENTS.FACTION_RENAMED").replace("%OLD_NAME%", playerFaction.getName()).replace("%NEW_NAME%", name).replace("%PLAYER%", player.getName()));
